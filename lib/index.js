...
*/
const CODEX_SUBSCRIPTION_MODEL = "gpt-image-2";
...
function apply(ctx, config) {
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			...
			if (requestedModel !== void 0 && config.authMode === "codex-subscription") throw new Error(`The Codex subscription endpoint fixes the image model to ${CODEX_SUBSCRIPTION_MODEL}. Use API-key mode to select a model.`);
			...
			try {
				const apiKeyReason = referenceImagePath !== void 0 ? "reference_image_path" : outputFormat !== "png" ? `${outputFormat.toUpperCase()} output` : requestBackground === "transparent" ? "transparent background output" : args.output_compression !== void 0 ? "output_compression" : requestedModel !== void 0 ? "model selection" : void 0;
