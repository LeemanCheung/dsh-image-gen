window.__ModuleLoader__.load({ id: "dsh-image-gen", factory: (require) => {
...
function referenceFromText(value) {
	...
	try {
		...
		if (!isRecord(parsed) || parsed.schema !== REFERENCE_SCHEMA || typeof parsed.callId !== "string" || !isRecord(parsed.image)) return void 0;
		return parsed;
	} catch {
		return;
	}
...
function presentationOf(block) {
	...
	if (isRecord(block.meta) && block.meta.schema === PRESENTATION_SCHEMA && isRecord(block.meta.result)) {
		...
		if (result.schema === RESULT_SCHEMA && isRecord(result.image) && result.callId === block.callId) return block.meta;
	}
...
function ImageGenCard({ sessionId, callId, block, t, requestProgress, requestImage }) {
	...
	const phase = progress?.state === "requesting" ? t("requesting") : progress?.state === "generating" ? t("rendering") : progress?.state === "saving" ? t("saving") : settled && presentation !== void 0 && finalImage === void 0 && !loadError ? t("loading") : t("waiting");
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: result?.size ?? args.size
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshImageGen__chip",
								children: result?.quality ?? args.quality
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshImageGen__chip",
